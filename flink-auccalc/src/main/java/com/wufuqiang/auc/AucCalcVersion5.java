...
public class AucCalcVersion5 {
    public static void main(String[] args) {
        ...
        String actionlogformat = "%s/recom/data_platform/action_log/%s/%02d/";
        String recalllogformat = "%s/recom/data_platform/feature_recall_log/%s/%02d/";
        ...
        if(isDaylyCalc){
            ...
            for(int i = 0;i<24;i++){
                ...
                if(actionlogExist){
                    ...
                    DataSet<String> oneActionDs = env.readTextFile(actionlogstr);
                ...
                if(recalllogExist){
                    ...
                    DataSource<String> oneRecallDs = env.readTextFile(recalllogstr);
            ...
            if(actionlogExist && recalllogExist){
                actionlogRawDs = env.readTextFile(actionlogstr);
                recalllogRawDs = env.readTextFile(recalllogstr);
...
//        aucAndUaucDs.output(new HBaseOutputFormatputFormat(tablename,time));
