...
public class ItemIdCf {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String today = args[0];
        int numDay = Integer.parseInt(args[1]);
        String outputPathStr = "hdfs://clusterA/tmp/huaban/itemcf/countStat/"+args[0]+"-"+args[1];
        String quDuanOutputStr = "hdfs://clusterA/tmp/huaban/itemcf/huaBanQuDuan/"+args[0]+"-"+args[1];
        ...
        String pathFormat = "%s/recom/action/218/1874/764/%s";
        //读取数据，合并成一个DataSet<String>
        for(int i = 0 ; i<numDay;i++){
            String actionPathStr = String.format(pathFormat,uri,today);
            try {
