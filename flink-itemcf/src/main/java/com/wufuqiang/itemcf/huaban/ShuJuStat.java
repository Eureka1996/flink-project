...
public class ShuJuStat {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String pathFormat = "/recom/petal/218/1874/764/%s";
        //计算哪一天开始的，之前的几天
        String today = args[0];
        //计算几天的数据量
        ...
        String outputPath = "hdfs://clusterA/tmp/huaban/countStat/"+args[0]+"-"+dayNum;
        String quDuanOutputPath = "hdfs://clusterA/tmp/huaban/huaBanQuDuan/"+args[0]+"-"+dayNum;
        ...
        Table huaBanTable = tableEnvironment.scan("HuaBan").as("itemId,boardId").distinct();
